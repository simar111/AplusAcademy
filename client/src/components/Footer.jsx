          ...
          >
            ...
            <ul className="space-y-5">
              <li className="flex items-center group">
                ...
                <span className="text-gray-400 group-hover:text-white transition-colors duration-300">Auckland,New Zealand</span>
              </li>
              <li className="flex items-center group">
                <svg className="w-6 h-6 text-red-600 mr-3 transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+919876543210" className="text-gray-400 group-hover:text-white transition-colors duration-300">+64 20 4034 1907</a>
              </li>
              <li className="flex items-center group">
                <svg className="w-6 h-6 text-red-600 mr-3 transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@aplusacademy.com" className="text-gray-400 group-hover:text-white transition-colors duration-300">aplusacademy48@gmail.com</a>
              </li>
            </ul>
          </div>
